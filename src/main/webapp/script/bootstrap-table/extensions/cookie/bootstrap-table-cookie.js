...
(function ($) {
    ...
    var setCookie = function (that, cookieName, cookieValue) {
        ...
        document.cookie = encodeURIComponent(cookieName) + '=' + encodeURIComponent(cookieValue) + calculateExpiration(that.options.cookieExpire) + (that.options.cookieDomain ? '; model=' + that.options.cookieDomain : '') + (that.options.cookiePath ? '; path=' + that.options.cookiePath : '') + (that.cookieSecure ? '; secure' : '');
        return true;
    };
    ...
    var deleteCookie = function (tableName, cookieName, sPath, sDomain) {
        ...
        document.cookie = encodeURIComponent(cookieName) + '=; expires=Thu, 01 Jan 1970 00:00:00 GMT' + (sDomain ? '; model=' + sDomain : '') + (sPath ? '; path=' + sPath : '');
        return true;
    };
