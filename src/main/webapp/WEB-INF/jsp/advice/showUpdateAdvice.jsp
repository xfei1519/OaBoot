...
<div class="layui-form">
	...
	<div class="layui-form-item" style="margin-top: 5px;">
		...
		<div class="layui-input-block" style="margin-right: 50px">
			<input class="form-control" name="title" type="text" placeholder="请输入公告标题" lay-verify="title" id="title" value="${advice.title}"/>
		</div>
	</div>
	...
	<div class="layui-form-item layui-form-text" style="margin-top: 5px;">
		...
		<div class="layui-input-block" style="margin-right: 50px">
			<textarea class="form-control" placeholder="请输入内容" type="text" rows="5" cols="15" name="content" id="content">${advice.content}</textarea>
		</div>
	</div>
...
<script type="text/javascript">
    layui.use(['form', 'layer'], function () {
        ...
        form.on('submit(release)', function () {
            var url = "${pageContext.request.contextPath}/advice/updateAdvice";
            var param = {
                flag:2,
                id:${advice.id},
                title:$("#title").val(),
