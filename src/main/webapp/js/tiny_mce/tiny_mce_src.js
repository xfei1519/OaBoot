...
(function() {
	...
	tinymce.create('tinymce.util.URI', {
		...
		toRelative : function(u) {
			...
			// Not on same model/port or protocol
	...
	tinymce.dom.ScriptLoader = function(settings) {
		...
		function loadScript(url, callback) {
			...
			if (tinymce.isIE6) {
				...
				// If script is from same model and we
...
(function(tinymce) {
	...
	tinymce.create('tinymce.Editor', {
		...
		init : function() {
			...
			// User specified a document.model value
			...
			// Domain relaxing enabled, then set document model
			if (tinymce.relaxedDomain && (isIE || (tinymce.isOpera && parseFloat(opera.version()) < 11))) {
				// We need to write the contents here in IE since multiple writes messes up refresh button and back button
				u = 'javascript:(function(){document.open();document.model="' + document.domain + '";var ed = window.parent.tinyMCE.get("' + t.id + '");document.write(ed.iframeHTML);document.close();ed.setupIframe();})()';
			}
