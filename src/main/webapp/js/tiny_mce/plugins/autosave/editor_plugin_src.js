 ...
 * 
 * 1. localStorage - A new feature of HTML 5, localStorage can store megabytes of data per model
 ...
 * way to store up to 128K of data per "document", or up to 1MB of data per model, on the client
